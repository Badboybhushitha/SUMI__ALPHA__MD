...
switch(command) {
  case 'quest':
    ...
    ZimBotInc.sendList(m.chat, `Hi Chomie *${pushname}*`, `Please Select Below`, "CLICK", "ʀᴘɢ ɢᴀᴍᴇ ʙʏ sumiʙᴏᴛ ", sectionnya, { quoted: m})
    break
    case 'slime':
    case 'killslime':
...
for (let yoi of anu) {
 ...
 urlButton: {
  displayText: 'GITHUB',
  url: 'https://github.com/Badboybhushitha/SUMI__ALPHA__MD'
 }
  }, {
 quickReplyButton: {
  displayText: 'OWNER',
...
urlButton: {
displayText: `GITHUB`, 
url: `https://github.com/Badboybhushitha/SUMI__ALPHA__MD/fork`
}
}, {
quickReplyButton: {
displayText: `VIDEO`,
 ...
 *ᴜᴘᴛɪᴍᴇ :* ${runtime(process.uptime())}
 ...
 └───────────●
        `,
         buttonText: "SET MENU",
         footerText: "SUMI BOT INC 4",
         listType: "SINGLE_SELECT",
         sections: [{
       "title": "SUMI BOT INC",
       "rows": [
       {
       "title": "TEMPLATE SUMI-BOT",
...
%readmore` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://www.youtube.com/channel/UCyx6idB-uZRFO3OThT_PWzw` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/Badboybhushitha/SUMI__ALPHA__MD/fork` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
